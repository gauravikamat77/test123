...
def process_image():
    ...
    # Resize the processed image to match the dimensions of the selected image
       ...
       # Convert processed image to PIL format
        ...
        # Modify the return statement in the process_image route
        return jsonify({'success': 'Image processed successfully!', 'data': {'processed_image_data': processed_image_data}})
